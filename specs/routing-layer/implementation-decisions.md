...
**Why it is not a nerf:** malformed output still fails closed, enum/range/additional-property checks remain enforced,
and the provider sees the exact same schema used at runtime.
