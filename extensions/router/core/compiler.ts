...
function outputContractFor(profile: PromptProfile, archetype?: Archetype): string {
  const contract = archetype
    ? (ARCHETYPE_OUTPUT_CONTRACTS[archetype] ?? profile.outputContract)
