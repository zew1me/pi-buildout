...
import type { ArchetypeDecision } from "./core/archetype.ts";
import { conservativeFeatures, TaskFeaturesSchema, validateTaskFeatures } from "./core/features.ts";
...
type ClassifierTransportResult = {
  arguments: unknown;
  provider: string;
  modelId: string;
  vendor: ModelVendor;
