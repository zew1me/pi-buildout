...
export function truncateMiddle(text: string, maxChars: number): string {
	...
	const marker = `\n\n[... ${text.length - maxChars} context characters omitted ...]\n\n`;
...
export function parseClassifierDecision(text: string): ClassifierDecision | undefined {
	...
	try {
		...
		if (typeof parsed.effort !== "string" || !THINKING_LEVELS.includes(parsed.effort as ThinkingLevel)) return undefined;
		return {
