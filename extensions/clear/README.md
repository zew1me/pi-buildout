...
Starts a replacement pi session, discarding the current conversation context. The new session includes a disclosure of
current-directory `AGENTS.md` and `CLAUDE.md` files, active skills, and active tools.
